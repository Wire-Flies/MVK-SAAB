...
describe('firebase.js', function() {
    ...
    describe('login()', function() {
        describe('successfull login', function() {
            beforeEach(function() {
                authMock = {
                    ...
                    createUserWithEmailAndPassword: sinon.stub().rejects(),
                    getUid: sinon.stub().returns('Akkjzumle0WDIxaUrvSVtawj98z1'),
                };
            ...
            it('has set user to \"firebase.auth.getUid()\"', function() {
                assert.equal(firebaseConnector.usr, 'Akkjzumle0WDIxaUrvSVtawj98z1');
            });
        });
        ...
        describe('unsuccessfull login', function() {
            ...
            it('has not set user to \"firebase.auth.getUid()\"', function() {
                assert.notEqual(firebaseConnector.usr, '');
            });
        });
    });
